...
const base = "https://emelkey.github.io/Max-saite";
...
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/nishi/">Ніші</a></span><span>Клінінг</span></nav>
  <section class="seo-hero reveal"><div><span class="eyebrow">Сайт для клінінгу</span><h1>Сайт для клінінгової компанії</h1><p>Будуємо зрозумілий шлях від пошуку конкретної послуги до дзвінка або заявки: окремі посадкові сторінки, приклади робіт, прозорий розрахунок і зручна мобільна версія.</p><div class="hero-buttons"><a class="btn" href="#lead">Обговорити сайт</a><a class="btn btn-ghost" href="/Max-saite/portfolio/#formula-chystoty">Подивитися кейс</a></div></div><aside class="seo-hero-card"><strong>від 10 500 грн</strong><p>Лендінг для однієї послуги. Для кількох напрямів і органічного пошуку рекомендуємо багатосторінкову структуру.</p></aside></section>
  <div class="seo-content">
    ...
    <section class="seo-links reveal"><h2>Пов’язані послуги</h2><div class="link-grid"><a href="/Max-saite/sajty-dlya-poslug/">Сайти для послуг</a><a href="/Max-saite/seo-sajt-pid-google/">SEO-сайт під Google</a><a href="/Max-saite/google-ads/">Google Ads</a><a href="/Max-saite/portfolio/">Портфоліо</a></div></section>
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/nishi/">Ніші</a></span><span>Локальний бізнес</span></nav>
  <section class="seo-hero reveal"><div><span class="eyebrow">Локальні заявки</span><h1>Сайт для локального бізнесу</h1><p>Допомагаємо перетворити локальний пошук, рекламу й переходи із соцмереж на зрозумілі дії: дзвінок, маршрут, повідомлення або заявку на розрахунок.</p><div class="hero-buttons"><a class="btn" href="#lead">Обговорити сайт</a><a class="btn btn-ghost" href="/Max-saite/mista/">Сторінки міст</a></div></div><aside class="seo-hero-card"><strong>Під ваше місто</strong><p>Не вигадуємо офісів і зон роботи. Географія, адреса та контакти на сайті мають відповідати реальному бізнесу.</p></aside></section>
  <div class="seo-content">
    ...
    ${faqMarkup(localFaq)}
    <section class="seo-links reveal"><h2>Пов’язані розділи</h2><div class="link-grid"><a href="/Max-saite/mista/">Сайти у містах</a><a href="/Max-saite/sajty-dlya-poslug/">Сайти для послуг</a><a href="/Max-saite/google-analytics-search-console/">Аналітика</a><a href="/Max-saite/kontakty/">Контакти</a></div></section>
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/nishi/">Ніші</a></span><span>Будівництво</span></nav>
  <section class="seo-hero reveal"><div><span class="eyebrow">Сайт для будівництва</span><h1>Сайт для будівельної компанії</h1><p>Структуруємо напрями робіт, об’єкти й умови співпраці так, щоб потенційний замовник розумів спеціалізацію компанії та залишав достатньо даних для предметної розмови.</p><div class="hero-buttons"><a class="btn" href="#lead">Обговорити проєкт</a><a class="btn btn-ghost" href="/Max-saite/stvorennya-sajtiv-pid-klyuch/">Що входить у розробку</a></div></div><aside class="seo-hero-card"><strong>від 19 700 грн</strong><p>Бізнес-сайт із головною та сторінками напрямів. Склад калькулятора й портфоліо оцінюємо після брифу.</p></aside></section>
  <div class="seo-content">
    ...
    <section class="seo-links reveal"><h2>Пов’язані послуги</h2><div class="link-grid"><a href="/Max-saite/korporatyvni-sajty/">Корпоративні сайти</a><a href="/Max-saite/seo-sajt-pid-google/">SEO-сайт</a><a href="/Max-saite/google-ads/">Google Ads</a><a href="/Max-saite/portfolio/">Портфоліо</a></div></section>
...
<main class="section seo-page">
  ...
  <div class="seo-content">
    ...
    ${faqMarkup(adsFaq)}
    <section class="seo-links reveal"><h2>Пов’язані послуги</h2><div class="link-grid"><a href="/Max-saite/google-analytics-search-console/">Analytics + Search Console</a><a href="/Max-saite/stvorennya-lendingiv/">Лендінги</a><a href="/Max-saite/sajty-dlya-poslug/">Сайти послуг</a><a href="/Max-saite/portfolio/">Кейси</a></div></section>
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/poslugy/">Послуги</a></span><span>Аналітика</span></nav>
  <section class="seo-hero reveal"><div><span class="eyebrow">Дані без здогадок</span><h1>Google Analytics і Search Console</h1><p>Налаштовуємо збір подій, перевіряємо індексацію та формуємо зрозумілу картину: звідки приходять відвідувачі, які сторінки приводять звернення і де Google бачить технічні проблеми.</p><div class="hero-buttons"><a class="btn" href="#lead">Підключити аналітику</a><a class="btn btn-ghost" href="/Max-saite/google-ads/">Google Ads</a></div></div><aside class="seo-hero-card"><strong>від 2 900 грн разово</strong><p>Щомісячний супровід двох інструментів — від 4 500 грн.</p></aside></section>
  <div class="seo-content">
    ...
    <section class="seo-links reveal"><h2>Пов’язані розділи</h2><div class="link-grid"><a href="/Max-saite/google-ads/">Google Ads</a><a href="/Max-saite/seo-sajt-pid-google/">SEO-сайт</a><a href="/Max-saite/poslugy/">Усі послуги</a><a href="/Max-saite/kontakty/">Контакти</a></div></section>
...
<main class="section seo-page">
  ...
  <div class="seo-content">
    ...
    <section class="seo-links reveal"><h2>Пов’язані сторінки</h2><div class="link-grid"><a href="/Max-saite/nishi/sajt-dlya-lokalnogo-biznesu/">Локальний бізнес</a><a href="/Max-saite/sajty-dlya-poslug/">Сайти послуг</a><a href="/Max-saite/google-ads/">Google Ads</a><a href="/Max-saite/mista/">Інші міста</a></div></section>
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/mista/">Міста</a></span><span>Київ</span></nav>
  <section class="seo-hero reveal"><div><span class="eyebrow">Київ</span><h1>Створення сайтів у Києві для бізнесу</h1><p>Для конкурентної пропозиції недостатньо додати назву міста в заголовок. Розділяємо аудиторії, послуги й сценарії звернення, щоб кожна важлива сторінка відповідала конкретному наміру.</p><div class="hero-buttons"><a class="btn" href="#lead">Обговорити проєкт</a><a class="btn btn-ghost" href="/Max-saite/seo-sajt-pid-google/">SEO-структура</a></div></div><aside class="seo-hero-card"><strong>Структура до дизайну</strong><p>Спочатку визначаємо пропозиції, сегменти й цільові дії, потім формуємо прототип і візуальну систему.</p></aside></section>
  <div class="seo-content">
    ...
    ${faqMarkup(kyivFaq)}
    <section class="seo-links reveal"><h2>Пов’язані послуги</h2><div class="link-grid"><a href="/Max-saite/stvorennya-lendingiv/">Лендінги</a><a href="/Max-saite/korporatyvni-sajty/">Корпоративні сайти</a><a href="/Max-saite/google-ads/">Google Ads</a><a href="/Max-saite/google-analytics-search-console/">Аналітика</a></div></section>
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/mista/">Географія</a></span><span>Україна</span></nav>
  <section class="seo-hero reveal"><div><span class="eyebrow">Дистанційна розробка</span><h1>Створення сайтів для бізнесу по Україні</h1><p>Розробляємо сайти дистанційно для компаній із національною або локальною моделлю роботи. Архітектура залежить від реальної географії бізнесу, а не від бажання створити максимальну кількість URL.</p><div class="hero-buttons"><a class="btn" href="#lead">Обговорити сайт</a><a class="btn btn-ghost" href="/Max-saite/mista/">Географія послуг</a></div></div><aside class="seo-hero-card"><strong>Без doorway-сторінок</strong><p>Місто отримує окрему сторінку тільки за наявності відмінної пропозиції, умов або корисного локального змісту.</p></aside></section>
  <div class="seo-content">
    ...
    <section class="seo-links reveal"><h2>Пов’язані розділи</h2><div class="link-grid"><a href="/Max-saite/stvorennya-sajtiv-pid-klyuch/">Сайти під ключ</a><a href="/Max-saite/nishi/">Сайти за нішами</a><a href="/Max-saite/seo-sajt-pid-google/">SEO-структура</a><a href="/Max-saite/portfolio/">Кейси</a></div></section>
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/blog/">Блог</a></span><span>Вартість сайту</span></nav>
  ...
  <div class="seo-content">
    <article class="article-body reveal">
      ...
      <p><a href="/Max-saite/stvorennya-sajtiv-pid-klyuch/">Переглянути, що входить у створення сайту під ключ</a>.</p>
    </article>
    ${faqMarkup(priceFaq)}
...
updatePage({
  ...
  main: `
<main class="section seo-page">
  <nav class="breadcrumbs" aria-label="Хлібні крихти"><span><a href="/Max-saite/">Головна</a></span><span><a href="/Max-saite/blog/">Блог</a></span><span>Лендінг чи корпоративний сайт</span></nav>
  ...
  <div class="seo-content">
    <article class="article-body reveal" id="comparison">
      ...
      <p><a href="/Max-saite/stvorennya-lendingiv/">Детальніше про лендінги</a> · <a href="/Max-saite/korporatyvni-sajty/">Детальніше про корпоративні сайти</a></p>
    </article>
    ${faqMarkup(choiceFaq)}
